...
// TODO - declare a random engine to be used across multiple and various method calls
...
void ParticleFilter::init(double x, double y, double theta, double std[]) {
    ...
    // Defines normal (Gaussian) distributions for x, y and theta (yaw).
    ...
    cout << "Y: " << particles[0].y << endl;
    cout << "Theta: " << particles[0].theta << endl;
